...
export const portalSections: PortalSection[] = [
  ...
  { slug: "fee-types", label: "Fee Types", area: "workspace", purpose: "Configure term fee and similar charge types", roles: ["Admin"], group: "Fee Management" },
  { slug: "fee-structures", label: "Fee Structures", area: "workspace", purpose: "Define fee templates", roles: ["Admin"], group: "Fee Management" },
  { slug: "student-charges", label: "Student Charges", area: "workspace", purpose: "Generate and manage charges", roles: ["Admin", "Office Staff"], group: "Fee Management" },
  { slug: "discounts", label: "Discounts", area: "workspace", purpose: "Apply sibling and scholarship discounts", roles: ["Admin"], group: "Fee Management" },
  { slug: "fine-management", label: "Fine Management", area: "workspace", purpose: "Configure and reverse fines", roles: ["Admin"], group: "Fee Management" },
  { slug: "fee-collection", label: "Fee Collection", area: "workspace", purpose: "Collect student payments", roles: ["Accountant", "Office Staff"], group: "Fee Management" },
  { slug: "receipts", label: "Receipts", area: "workspace", purpose: "View, print, and reverse receipts", roles: ["Accountant"], group: "Fee Management" },
  { slug: "refunds", label: "Refunds", area: "workspace", purpose: "Handle admission cancellation and overpayment refunds", roles: ["Accountant", "Admin"], group: "Fee Management" },
  { slug: "events", label: "Events", area: "workspace", purpose: "Create events and contributions", roles: ["Admin"], group: "Fee Management" },
  { slug: "event-collections", label: "Event Collections", area: "workspace", purpose: "Collect event contributions", roles: ["Accountant"], group: "Fee Management" },
  { slug: "expenses", label: "Expenses", area: "workspace", purpose: "Record expenses", roles: ["Accountant"], group: "Fee Management" },
  { slug: "vendors", label: "Vendors", area: "workspace", purpose: "Manage vendors", roles: ["Accountant"], group: "Fee Management" },
  { slug: "accounts", label: "Accounts", area: "workspace", purpose: "Manage income and expense accounts", roles: ["Admin"], group: "Fee Management" },
  { slug: "payroll", label: "Payroll", area: "workspace", purpose: "Generate and track salaries", roles: ["Accountant"], group: "Fee Management" },
  { slug: "staff-deductions", label: "Staff Deductions", area: "workspace", purpose: "Manage recoveries and deductions", roles: ["Accountant"], group: "Fee Management" },
  { slug: "late-fee-reminders", label: "Late Fee Reminders", area: "workspace", purpose: "Send payment reminders", roles: ["Accountant", "Office Staff"], group: "Fee Management" },
...
export function getPortalNavItems(area: PortalArea, role?: string | null) {
  ...
  return portalSections
    ...
    .map((section) => ({
      slug: section.slug,
      href: section.slug === "dashboard" ? `/${area}` : `/${area}/${section.slug}`,
      label: section.label,
