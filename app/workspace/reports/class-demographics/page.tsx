            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                ...
                <Card className="border border-slate-200 dark:border-slate-800 shadow-xs bg-white dark:bg-slate-900">
                    ...
                    <CardContent>
                        ...
                        <p className="text-xs text-slate-500 mt-1">Across {data?.summary.totalClasses ?? 0} classes</p>
                    </CardContent>
                </Card>
                ...
                <Card className="border border-slate-200 dark:border-slate-800 shadow-xs bg-white dark:bg-slate-900">
                    ...
                    <CardContent>
                        ...
                        <p className="text-xs text-slate-500 mt-1">Male student headcount</p>
                    </CardContent>
                </Card>
                ...
                <Card className="border border-slate-200 dark:border-slate-800 shadow-xs bg-white dark:bg-slate-900">
                    ...
                    <CardContent>
                        ...
                        <p className="text-xs text-slate-500 mt-1">Female student headcount</p>
                    </CardContent>
                </Card>
                ...
                <Card className="border border-slate-200 dark:border-slate-800 shadow-xs bg-white dark:bg-slate-900">
                    ...
                    <CardContent>
                        ...
                        <p className="text-xs text-slate-500 mt-1">Active class standards</p>
                    </CardContent>
                </Card>
            </div>
                                ...
                                {loading ? (
                                    ...
                                    data.classMatrix.map((cls) => (
                                        <React.Fragment key={cls.classId}>
                                            <tr className="bg-slate-50/50 dark:bg-slate-800/20 font-bold border-t border-slate-200 dark:border-slate-700">
                                                ...
                                                <td className="px-4 py-3 text-right">
                                                    <span className="inline-flex items-center px-2 py-0.5 rounded-full text-xs font-bold bg-slate-100 text-slate-900 border border-slate-300 dark:bg-slate-800 dark:text-slate-100">
                                                        {cls.totalStudents}
                                                    </span>
                                                </td>
                                            </tr>
                    ...
                    <CardContent className="pt-4">
                        <div className="flex flex-wrap gap-2.5">
                            {data.bloodGroupSummary.map((bg) => (
                                ...
                                >
                                    <span className="font-bold text-rose-600 dark:text-rose-400">{bg.bloodGroup}</span>
                                    <span className="text-slate-400">|</span>
                                    <span className="font-semibold text-slate-900 dark:text-slate-100">{bg.studentCount} Students</span>
                                </div>
                            ))}
                        </div>
                    </CardContent>
