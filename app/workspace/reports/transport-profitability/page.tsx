        ...
        return (
            <div className="flex h-96 items-center justify-center p-8 text-center font-sans">
                <div className="max-w-md">
                    ...
                    <p className="mt-2 text-sm text-slate-500 dark:text-slate-400">You do not have permission to view Transport Reports.</p>
                </div>
            </div>
        );
    }
    ...
    return (
        <div className="w-full space-y-4 px-3 py-4 sm:space-y-6 sm:px-6 max-w-7xl mx-auto font-sans min-h-screen">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                ...
                <div className="rounded-xl border border-slate-200 bg-white p-4 shadow-sm dark:border-slate-800/60 dark:bg-slate-900/50">
                    <div className="flex items-center justify-between">
                        <span className="text-xs font-medium uppercase tracking-wider text-slate-500 dark:text-slate-400">Driver Salaries Paid</span>
                    ...
                    <p className="mt-1 text-xs text-slate-500 dark:text-slate-400">Driver payroll compensation</p>
                </div>

                {/* 4. Net Balance */}
                <div className="rounded-xl border border-slate-200 bg-white p-4 shadow-sm dark:border-slate-800/60 dark:bg-slate-900/50">
                    <div className="flex items-center justify-between">
                        <span className="text-xs font-medium uppercase tracking-wider text-slate-500 dark:text-slate-400">Net Fleet Balance</span>
                    ...
                    <table className="w-full text-left text-sm font-sans">
                        ...
                        {data?.vehicles && data.vehicles.length > 0 && (
                            <tfoot className="bg-slate-50 dark:bg-slate-800/80 font-bold border-t-2 border-slate-300 dark:border-slate-700 text-sm">
                                <tr>
                                    <td className="px-4 py-3 text-slate-900 dark:text-slate-100">Total Fleet</td>
                                    ...
                                    <td className="px-4 py-3 text-right text-slate-700 dark:text-slate-300 font-normal">
