        ...
        return (
            <div className="flex h-96 items-center justify-center p-8 text-center">
                <div className="max-w-md">
                    ...
                    <p className="mt-2 text-sm text-slate-500">You do not have permission to view Income Reports.</p>
                </div>
            </div>
        );
    }
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                ...
                <Card className="border border-slate-200 dark:border-slate-800 shadow-xs bg-white dark:bg-slate-900">
                    ...
                    <CardContent>
                        ...
                        <p className="text-xs text-slate-500 mt-1">Paid penalty amount</p>
                    </CardContent>
                </Card>
                ...
                <Card className="border border-slate-200 dark:border-slate-800 shadow-xs bg-white dark:bg-slate-900">
                    ...
                    <CardContent>
                        ...
                        <p className="text-xs text-slate-500 mt-1">Forgiven by school</p>
                    </CardContent>
                </Card>
                        ...
                        <table className="w-full text-left text-sm">
                            ...
                            <tbody className="divide-y divide-slate-100 dark:divide-slate-800 font-medium">
                                {loading ? (
                                    ...
                                    data.fines.map((f) => (
                                        <tr key={f.fineId} className="hover:bg-slate-50/80 dark:hover:bg-slate-800/40 transition">
                                            <td className="px-4 py-3 text-xs text-slate-500 font-mono">
                                                {f.leviedDate ? new Date(f.leviedDate).toLocaleDateString("en-IN") : "-"}
                                            </td>
                                            <td className="px-4 py-3 font-semibold text-slate-900 dark:text-slate-100">
                                                {f.studentName}
                                                <div className="text-[11px] font-mono text-slate-500">{f.admissionNumber}</div>
                                            </td>
                                            ...
                                            <td className="px-4 py-3">
                                                ...
                                                <div className="text-[11px] text-slate-500 truncate max-w-[200px]">{f.reason}</div>
                                            </td>
