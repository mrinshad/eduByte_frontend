        ...
        <div className="mt-6 space-y-6">
            ...
            <Card className="overflow-hidden border-slate-200 bg-white shadow-sm dark:border-slate-800/60 dark:bg-slate-900/50 w-full">
                ...
                <CardContent className="p-0">
                    ...
                    <div className="hidden items-center gap-4 border-b border-slate-100 bg-slate-50/80 px-4 py-3 sm:flex sm:px-5 dark:border-slate-800/60 dark:bg-slate-950/40">
                ...
                <div className="flex items-center justify-between border-t border-slate-100 bg-slate-50/80 px-4 py-4 sm:px-5 dark:border-slate-800/60 dark:bg-slate-950/40">
            ...
            {!loading && feeStructure && (
                <div className="mt-6 space-y-6">
                                        ...
                                        <div className="sm:col-span-2 xl:col-span-3 rounded-2xl border border-slate-100 bg-slate-50/80 p-4 dark:border-slate-800/60 dark:bg-slate-950/40">
                                            <div className="flex items-start gap-3">
                                                ...
                                                <div className="min-w-0">
                                                    ...
                                                    <p className="mt-1 break-words text-sm leading-6 text-slate-950 dark:text-slate-100">
                                                        {feeStructure.description || "No description provided"}
                                                    </p>
                                                </div>
                                            </div>
                    ...
                    <Card className="overflow-hidden border-slate-200 bg-white shadow-sm dark:border-slate-800/60 dark:bg-slate-900/50 w-full">
                        ...
                        <div className="flex flex-col gap-1 border-t border-slate-100 bg-slate-50/80 px-4 py-4 sm:flex-row sm:items-center sm:justify-between sm:px-5 dark:border-slate-800/60 dark:bg-slate-950/40">
